...
export function OverrideManager({ employee, fields, initialOverrides, history, apiConfigured, canManage = true }: { employee: Employee; fields: AssignmentField[]; initialOverrides: EmployeeOverride[]; history: Assignment[]; apiConfigured: boolean; canManage?: boolean }) {
