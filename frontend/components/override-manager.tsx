    ...
    <div className="section-stack">
      ...
      <section className="panel">
        <div className="panel-header">
          ...
          {canManage && (
            <button className="button secondary small" onClick={() => openEditor()}>
            ...
            <tbody>
              {history.map((assignment) => (
                <tr key={assignment.id}>
                  ...
                  <td>
                    <span
                      className={`badge ${assignment.source_override_id ? "warning" : "accent"}`}
                    >
        ...
        <div className="modal-backdrop" role="presentation">
          ...
          >
            ...
            <div className="heading-actions">
              ...
              <button
                className={`button${pending.action === "delete" ? " danger-button" : ""}`}
                disabled={busy}
                onClick={confirm}
              >
