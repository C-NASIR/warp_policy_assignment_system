...
import formStyles from "./styles/form-surfaces.module.css";
import policyStyles from "./styles/policy-authoring.module.css";
import managementStyles from "./styles/management-surfaces.module.css";
import authStyles from "./styles/auth-surface.module.css";
import interactionStyles from "./styles/interaction-surfaces.module.css";
...
export function AppShell({
  ...
  const productScope = classNames(
    shellStyles.productScope,
    productStyles.productScope,
    detailStyles.productScope,
    formStyles.productScope,
    policyStyles.productScope,
    managementStyles.productScope,
    authStyles.productScope,
    interactionStyles.productScope,
  );
  ...
  if (pathname === "/" || pathname.startsWith("/learn")) return <>{children}</>;

  if (isStandalonePage) return <div className={productScope}>{children}</div>;

  return (
    <div className={productScope}>
                  ...
                  {activityOpen && (
                    <div className="activity-popover">
                      <div className="popover-head">
                        ...
                        <Badge tone="accent">{visibleActivity.length} new</Badge>
                      </div>
              ...
              <div className="command-results" role="listbox">
                ...
                {filteredCommands.length === 0 && (
                  <div className="command-empty">
                    No matching page, action, or learning article.
                  </div>
                )}
              </div>
