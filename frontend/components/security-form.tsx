      ...
      <div className="detail-main">
        ...
        <section className="panel security-panel">
          <div className="panel-header">
            ...
            <span className={`badge ${security.mfa_enabled ? "success" : "warning"}`}>
              <ShieldCheck size={11} />
        ...
        <section className="panel">
          ...
          <div className="panel-body">
            ...
            <div className="security-actions">
              ...
              <button className="button danger" disabled={busy} onClick={revokeAll}>
                Sign out all
              </button>
            </div>
          </div>
              ...
              {security.events.map((item) => (
                <div className="security-list-item" key={item.id}>
                  ...
                  {!item.acknowledged_at && item.severity !== "info" && (
                    <button className="button secondary small" onClick={() => acknowledge(item.id)}>
                      Acknowledge
                    </button>
                  )}
                </div>
