  ...
  return (
    <>
      ...
      <div className="detail-hero">
        ...
        <EmployeeEditor employee={employee} employees={allEmployees} fields={fields} currentAssignments={assignments} apiConfigured={apiConfigured} trigger={<><Pencil size={14} /> Edit employee</>} compact />
      </div>
      <div className="detail-grid">
        <div className="section-stack">
          <section className="panel"><div className="panel-header"><h2 className="panel-title">Current assignments</h2><span className="badge success">{assignments.length} resolved</span></div><div className="panel-body">
