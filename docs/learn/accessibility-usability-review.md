...
reporting tree, and why policies do not change user roles. Do not coach. Record
completion, wrong turns, terms
visited, and the learner's explanation—not customer or employee data.

Success means the reader completes all four explanations, distinguishes action
