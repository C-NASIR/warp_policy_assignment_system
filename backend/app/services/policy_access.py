...
def policy_capabilities(
    ...
    return PolicyCapabilitiesRead(
        can_update=_has_permission(principal, LEGACY_POLICY_MANAGE),
        can_create_version=(
        ...
        can_activate=(
            policy.status != "active" and can_activate_permission
        ),
        can_archive=(
